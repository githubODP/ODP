...
{
    public class VeiculoOrdemJudicialMapping : IEntityTypeConfiguration<VeiculoOrdemJudicial>
    {
        public void Configure(EntityTypeBuilder<VeiculoOrdemJudicial> builder)
        {
            ...
            builder.ToTable("VeiculosJudiciais");
        }
    }
}
