...
{
    public class VeiculoProntuarioMapping : IEntityTypeConfiguration<VeiculoProntuario>
    {
        public void Configure(EntityTypeBuilder<VeiculoProntuario> builder)
        {
            ...
            builder.ToTable("VeiculosProntuario");
        }
    }
}
