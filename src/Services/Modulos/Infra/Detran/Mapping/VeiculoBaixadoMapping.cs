...
{
    public class VeiculoBaixadoMapping : IEntityTypeConfiguration<VeiculoBaixado>
    {
        public void Configure(EntityTypeBuilder<VeiculoBaixado> builder)
        {
            ...
            builder.ToTable("VeiculosBaixados");
        }
    }
}
