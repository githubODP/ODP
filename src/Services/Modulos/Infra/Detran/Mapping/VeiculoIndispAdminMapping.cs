...
{
    public class VeiculoIndispAdminMapping : IEntityTypeConfiguration<VeiculoIndispAdmin>
    {
        public void Configure(EntityTypeBuilder<VeiculoIndispAdmin> builder)
        {
            ...
            builder.ToTable("VeiculosIndisponivel");
        }
    }
}
