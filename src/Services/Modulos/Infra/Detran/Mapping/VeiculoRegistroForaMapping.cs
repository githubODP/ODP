...
{
    public class VeiculoRegistroForaMapping : IEntityTypeConfiguration<VeiculoRegistroFora>
    {
        public void Configure(EntityTypeBuilder<VeiculoRegistroFora> builder)
        {
            ...
            builder.ToTable("VeiculosRegistradoFora");
        }
    }
}
