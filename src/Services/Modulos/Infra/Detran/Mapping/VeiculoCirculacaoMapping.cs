...
{
    public class VeiculoCirculacaoMapping : IEntityTypeConfiguration<VeiculoCirculacao>
    {
        public void Configure(EntityTypeBuilder<VeiculoCirculacao> builder)
        {
            ...
            builder.ToTable("VeiculosCirculacao");
        }
    }
}
