...
{
    public class DoacaoGeralController : MainController
    {
        private readonly IDoacaoGeralService _doacaoService;

        public DoacaoGeralController(IDoacaoGeralService doacaoService)
        {
