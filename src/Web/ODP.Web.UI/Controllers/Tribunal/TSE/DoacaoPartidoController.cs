...
{
    public class DoacaoPartidoController : MainController
    {
        private readonly IDoacaoPartidoService _doacaoService;

        public DoacaoPartidoController(IDoacaoPartidoService doacaoService)
        {
