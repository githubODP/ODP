...
{
    public class FornecedorPartidoController : MainController
    {
        private readonly IFornecedorPartidoService _doacaoService;

        public FornecedorPartidoController(IFornecedorPartidoService doacaoService)
        {
